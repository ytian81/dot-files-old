...
" powerline
source /usr/local/anaconda3/lib/python3.6/site-packages/powerline/bindings/vim/plugin/powerline.vim
set t_Co=256
...
set cursorline
hi CursorLine   cterm=NONE ctermbg=238 ctermfg=green guibg=black guifg=green
